...
namespace MTLFX
{
    namespace Private
    {
        namespace Protocol
        {
            ...
            _MTLFX_PRIVATE_DEF_PRO( MTLFXFrameInterpolator );
        } // Protocol
    } // Private
} // MTLFX
...
namespace MTLFX
{
    namespace Private
    {
        namespace Selector
        {
            ...
            _MTLFX_PRIVATE_DEF_SEL( previousColorTexture,
                                    "previousColorTexture" );
            _MTLFX_PRIVATE_DEF_SEL( setPreviousColorTexture_,
                                    "setPreviousColorTexture:" );
            _MTLFX_PRIVATE_DEF_SEL( previousColorTextureUsage,
                                    "previousColorTextureUsage" );
